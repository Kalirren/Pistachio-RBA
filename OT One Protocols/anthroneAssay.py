...
B.pick_up_tip()
B.distribute( (50,0), Glucose,   Assay96.rows('1'),new_tip = 'never')
B.distribute( (50,0), Glucose,   Assay96.rows('5'),new_tip = 'never')
B.distribute( (50,0), Glucose,   Assay96.rows('9'),new_tip = 'never')
B.drop_tip()
B.pick_up_tip()
B.distribute( (0,50), Water,   Assay96.rows('1'),new_tip = 'never')
B.distribute( (0,50), Water,   Assay96.rows('5'),new_tip = 'never')
B.distribute( (0,50), Water,   Assay96.rows('9'),new_tip = 'never')
B.drop_tip()
#Sample pipetting:
for i in range(3):
    for j in range(4):
...
#Adding anthrone:
for targetwell in Assay96.wells('A1', 'A2', 'A3', 'A4', 'A6', 'A7', 'A8', 'A10', 'A11', 'A12', 'A5', 'A9'):
